...
public class TeamService {
	...
	@RequestMapping("/flag/special/{sigla}")
	public ResponseEntity<byte[]> specialFlag(@PathVariable String sigla) throws IOException {
	    
		File dir = new File(Paths.JELASTIC_FILES
        		+ File.separator + "images" + File.separator + "flags" + File.separator + "special");
        File serverFile = new File(dir.getAbsolutePath()
                + File.separator + sigla.toUpperCase() + ".png");
	...
	public ResponseEntity<byte[]> image(@PathVariable String sigla) throws IOException {
		...
		File dir = new File(Paths.JELASTIC_FILES
        		+ File.separator + "images" + File.separator + "choices-flags");
        File serverFile = new File(dir.getAbsolutePath()
                + File.separator + sigla.toUpperCase() + ".png");
